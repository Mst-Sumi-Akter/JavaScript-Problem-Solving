...
For multiples of 3, print "Ping"  <br>
For multiples of 5, print "Pong" <br>
For multiples of both 3 and 5, print "PingPong" <br>
If the number is not a multiple of 3 or 5, print the number itself <br>
Example Output:
